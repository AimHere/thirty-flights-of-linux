...
void M_Credits_MenuDraw( void )
{
	...
	Menu_DrawString(leftMargin + specialThanksOffset, 270, "^7SPECIAL THANKS", 128);

	Menu_DrawString(leftIndent + specialThanksOffset, 280, "^7Brian Chan", 255);			Menu_DrawString(210, 280, "^7bchan.org", 128);
	Menu_DrawString(leftIndent + specialThanksOffset, 290, "^7Dustin Darcy", 255);
	Menu_DrawString(leftIndent + specialThanksOffset, 300, "^7MJ Kwan", 255);
	Menu_DrawString(leftIndent + specialThanksOffset, 310, "^7Mimi Kwan", 255);
	Menu_DrawString(leftIndent + specialThanksOffset, 320, "^7Mike Tipul", 255);			Menu_DrawString(210, 320, "^7nukeitfromorbit.tv", 128);	
	Menu_DrawString(leftIndent + specialThanksOffset, 330, "^7Neil Mehta", 255);
	Menu_DrawString(leftIndent + specialThanksOffset, 340, "^7Rob MacBride", 255);		Menu_DrawString(210, 340, "^7cargocollective.com/robmacbfolio", 128);
	Menu_DrawString(leftIndent + specialThanksOffset, 350, "^7Robert Yang", 255);			Menu_DrawString(210, 350, "^7blog.radiator.debacle.us", 128);
	Menu_DrawString(leftIndent + specialThanksOffset, 360, "^7Sanjay Madhav", 255);
	Menu_DrawString(leftIndent + specialThanksOffset, 370, "^7Ty Taylor", 255);			Menu_DrawString(210, 370, "^7tytaylor.info", 128);
	Menu_DrawString(leftIndent + specialThanksOffset, 380, "^7Wallace Huang", 255);
	Menu_DrawString(leftIndent + specialThanksOffset, 390, "^7Owen Macindoe", 255);		Menu_DrawString(210, 390, "^7people.csail.mit.edu/owenm", 128);
